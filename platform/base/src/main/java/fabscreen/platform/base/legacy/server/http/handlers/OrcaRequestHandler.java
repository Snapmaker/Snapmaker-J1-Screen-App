...
//            HTTPEventBus.getInstance().onReceiveFile(targetFile);
        ...
        new SuperToastHelper.Builder()
                ...
                .setTitle(appService.getNowViewContext().getString(R.string.a400_all_file_received))
    ...
    void checkVersion(HttpResponse response) {
        ...
        try {
            ...
            versionResponse.put("text", "OctoPrint 1.2.3/J1s Screen Dummy");
    ...
    void getRoot(HttpResponse response) {
        ...
        String html = "<!DOCTYPE html>"
                ...
                + "<span>" + (machineName != null ? machineName : "J1/J1s Device") + "</span>"
                + "</div>"
                ...
                + "</div>"
                + "<div class=\"footer\">"
                + "Powered by <a href=\"#\">J1/J1s Server beta</a>"
                + "</div>"
                + "</body></html>";
                ...
                Disposable ParserSub = mParser.getParseProgressObservable()
                        ...
                        .subscribe(progress -> {
                            if (progress == -1) {
                                ...
                                workspace.setPrintMode(mParser.getPrintMode());
                                ...
                                workspace.setFileMD5Value(Md5Util.fileToMD5(file.getAbsolutePath()));
