...
public class Position {
    public static final float INITIAL_X = Float.MIN_VALUE;
    public static final float INITIAL_Y = Float.MIN_VALUE;
    public static final float INITIAL_Z = Float.MIN_VALUE;
