package fabscreen.features.settings.a350.wifi;

import static fabscreen.platform.base.lib.network.NetworkController.ConnectResult.FAIL_WRONG_PASSWORD;
import static fabscreen.platform.base.lib.network.NetworkController.ConnectResult.SUCCESS;
...
public class SettingsWifiFragment extends BaseFragment {
    ...
    @BindView(R2.id.btn_settings_wifi_switch)
    Button mBtnWifiSwitch;
    @BindView(R2.id.lv_settings_wifi_access_point_list)
    ListView mLvAccessPointListView;
    @BindView(R2.id.view_settings_wifi_searching)
    View mViewSearching;
    @BindView(R2.id.view_settings_wifi_no_found)
    View mViewNoFound;
    // ListView shows APs connected
    @BindView(R2.id.lv_settings_wifi_connected_access_point_list)
    ...
    @OnClick(R2.id.btn_settings_wifi_switch)
