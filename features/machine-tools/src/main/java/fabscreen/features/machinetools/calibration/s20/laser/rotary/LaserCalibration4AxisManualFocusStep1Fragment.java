...
public class LaserCalibration4AxisManualFocusStep1Fragment extends BaseFragment {
    ...
    public static LaserCalibration4AxisManualFocusStep1Fragment newInstance() {
        return new LaserCalibration4AxisManualFocusStep1Fragment();
    }
    ...
    void onClickNext() {
        ...
        gotoInitialPosition()
                ...
                .subscribe(success -> {
                    ...
                    if (getActivity() != null) {
                        ((CalibrationLaserActivity) getActivity()).goto4AxisManualFocusStep2Fragment();
                    }
                }, e -> {
                    mBtnNext.setEnabled(true);
                    LogHelper.log(e);
