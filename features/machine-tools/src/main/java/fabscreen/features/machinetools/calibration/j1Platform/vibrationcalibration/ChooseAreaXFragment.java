...
public class ChooseAreaXFragment extends BaseFragment {


    private VibrationCalibrationViewModel mViewModel;

    public static Fragment newInstance() {
        return new ChooseAreaXFragment();
    }
    ...
    private void initView() {
        mTvTitle.setText(R.string.j1_calibration_vibration_choose_x_best_area_title);
    ...
    void onNextClicked() {
        ...
        mViewModel.enableAndSetCompensationFreq(1, checkedIndex)
    ...
    private void handleResult(Boolean success) {
        ...
        if (requireActivity() instanceof VibrationCalibrationActivity) {
            ((VibrationCalibrationActivity) requireActivity()).goToCalibrateSuccess();
        }
    }
}
