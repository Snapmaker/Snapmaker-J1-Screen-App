...
public class A400CalibrationLevelingZSelectionFragment extends BaseFragment {
    ...
    private List<CalibrationModeSelectionItem> getSections() {
        items.add(new CalibrationModeSelectionItem(R.string.calibration_auto_mode, R.string.calibration_heated_z_leveing_auto_content));
        items.add(new CalibrationModeSelectionItem(R.string.calibration_manual_mode, R.string.calibration_heated_z_leveing_manual_content));
        items.add(new CalibrationModeSelectionItem(R.string.calibration_sensor_travel_calibration, R.string.calibration_heated_z_leveing_sensor_travel_calibration_content));
        return items;
    }
