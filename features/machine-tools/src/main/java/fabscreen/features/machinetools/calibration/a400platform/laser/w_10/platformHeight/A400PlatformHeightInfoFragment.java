...
public class A400PlatformHeightInfoFragment extends A400CalibrationBaseInfoFragment {
    ...
    private void updateView() {
        ...
        mTvInfoShowTitle.setText(R.string.calibration_platfrom_height_title);
        mTvInfoShowContent.setText(R.string.calibration_platfrom_height_content);
                    ...
                    if (responseStructure.isSuccess()) {
                        DecisionDialog.create(getContext())
                                ...
                                .setTitle(getString(R.string.calibraiton_a400_procedure_start_confirm_dialog_title,
                                        getString(R.string.calibration_platfrom_height_title)))
