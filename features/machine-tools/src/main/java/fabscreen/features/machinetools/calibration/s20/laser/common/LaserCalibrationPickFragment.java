        ...
        ServiceContainer.getInstance().getService(IMachine.class).getLaserController()
                ...
                .subscribe(success -> {
                    ...
                    if (true) {
                        ...
                        vector2.setX(0);
                        vector2.setY(0);
                        mMachineController.gotoAbsolutePosition(vector2)//.sendGcode("G0 X0 Y0 F3000")
                                .flatMap(res -> {
                                    Vector vector1 = new Vector();
                                    vector1.setZ(offset);
                                    return mMachineController.gotoAbsolutePosition(vector1);
                                })//endGcode("G0 Z" + offset + " F1800"))
                                .flatMap(res -> {
