...
public class A400ThicknessMeasurementInfoFragment extends A400CalibrationBaseInfoFragment {
    ...
    private void updateView() {
        ...
        mTvInfoShowTitle.setText(R.string.calibration_thickness_measurement_title);
        mTvInfoShowContent.setText(R.string.calibration_thickness_measurement_content);
                    ...
                    if (responseStructure.isSuccess()) {
                        DecisionDialog.create(getContext())
                                ...
                                .setTitle(getString(R.string.calibraiton_a400_procedure_start_confirm_dialog_title,
                                        getString(R.string.calibration_thickness_measurement_title)))
