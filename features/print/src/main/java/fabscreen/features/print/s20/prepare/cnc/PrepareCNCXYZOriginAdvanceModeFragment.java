...
public class PrepareCNCXYZOriginAdvanceModeFragment extends BaseFragment {

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);

        setTitle("2-2 准备CNC作业");
    }

    @Override
    protected int getLayoutResID() {
        return R.layout.fragment_prepare_cnc_advance_mode;
    }
    ...
    @OnClick(R2.id.btn_prepare_cnc_advance_mode_next)
    void onClickNext() {
    ...
    @OnClick(R2.id.btn_prepare_cnc_advance_mode_select_mode)
