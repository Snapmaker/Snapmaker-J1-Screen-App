...
public class PrepareLaserWorkHeightTouchMaterialFragment extends BaseFragment {
    ...
    protected int getLayoutResID() {
        return R.layout.fragment_prepare_laser_work_height_touch_material;
    }

    @OnClick(R2.id.btn_prepare_laser_work_height_touch_material_next)
    void onClickNext() {
    ...
    @OnClick(R2.id.btn_prepare_laser_work_height_touch_material_select_mode)
