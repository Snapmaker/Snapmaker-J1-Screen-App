...
public class PrintA400AdjustmentRightZOffsetFragment extends BaseFragment {
    ...
    private void initView() {
        if (getParentFragment() instanceof PrintA400AdjustmentContainerFragment) {
            ((PrintA400AdjustmentContainerFragment) getParentFragment()).setModelTitle(getString(R.string.a400_print_print_setting_right_z_offset));
        }
    ...
    void onClickZOffsetDown() {
        ...
        mJ1Machine.getFDMController().setZOffset(0, 1, mZOffsetSubject.getValue() - mOffsetSize)
