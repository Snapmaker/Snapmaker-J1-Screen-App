...
public class PrepareLaserWorkHeightInputMaterialFragment extends BaseFragment {
    ...
    protected int getLayoutResID() {
        return R.layout.fragment_prepare_laser_work_height_intput_material;
    }

    @OnClick(R2.id.btn_prepare_laser_work_height_input_material_next)
    void onClickNext() {
    ...
    @OnClick(R2.id.btn_prepare_laser_work_height_input_material_select_mode)
