...
import fabscreen.features.print.j1platform.viewmodel.PrintJ1AdjustmentLightingViewModel;
...
public class PrintJ1AdjustmentLightingFragment extends BaseFragment {
    ...
    @BindView(R2.id.cas_j1_print_adjustment_lighting)
    CustomArcSeekBar mCasEnclosureLighting;

    IMachine mMachine;

    private PrintJ1AdjustmentLightingViewModel mViewModel;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = getFragmentScopeViewModel(PrintJ1AdjustmentLightingViewModel.class);
