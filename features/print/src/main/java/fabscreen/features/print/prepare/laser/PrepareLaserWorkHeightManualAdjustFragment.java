...
public class PrepareLaserWorkHeightManualAdjustFragment extends BaseFragment {
    ...
    protected int getLayoutResID() {
        return R.layout.fragment_prepare_laser_work_height_manual_adjust;
    }

    @OnClick(R2.id.btn_prepare_laser_work_height_manual_adjust_next)
    void onClickNext() {
    ...
    @OnClick(R2.id.btn_prepare_laser_work_height_manual_adjust_select_mode)
