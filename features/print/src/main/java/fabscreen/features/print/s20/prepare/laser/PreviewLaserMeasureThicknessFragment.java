...
public class PreviewLaserMeasureThicknessFragment extends BaseFragment {
    @BindView(R2.id.btn_place_material_next)
    Button mBtnNext;
    ...
    @OnClick(R2.id.btn_place_material_next)
    void onNextClick() {
    ...
    public void onHiddenChanged(boolean hidden) {
        ...
        if (hidden) {
            ...
            // "unexpectedly".
            mDelayDisposable = AndroidSchedulers.mainThread().scheduleDirect(() -> mViewModel.switchAFAssistLight(true), 200, TimeUnit.MILLISECONDS);
        }
    }
