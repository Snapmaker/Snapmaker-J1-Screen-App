...
import fabscreen.features.welcome.s20.WelcomeActivity;
import fabscreen.features.welcome.s20.WelcomeNameFragment;
...
public class A400WelcomeNameFragment extends BaseFragment {
    @BindView(fabscreen.platform.core.R2.id.et_welcome_name_input)
    EditText mEtMachineName;
    @BindView(fabscreen.platform.core.R2.id.btn_welcome_name_next)
    Button mBtnNext;
