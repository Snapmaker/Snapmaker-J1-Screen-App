...
public class GuideCNCSafetyGogglesFragment extends BaseFragment {
    ...
    public static GuideCNCSafetyGogglesFragment newInstance() {
        return new GuideCNCSafetyGogglesFragment();
    }
    ...
    private void initView() {
        mIvCover.setImageResource(R.drawable.pic_guide_cnc_safety_goggles_360x320);
    ...
    void onClickNext() {
        ...
        if (getActivity() != null) {
            ((GuideCNCActivity) getActivity()).startPrepareMaterialFragment();
        }
    }
}
