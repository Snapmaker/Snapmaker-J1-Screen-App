...
import fabscreen.platform.core.ui.view.VerticalRulerView;
import fabscreen.platform.lib.LogHelper;
import io.reactivex.android.schedulers.AndroidSchedulers;
import io.reactivex.subjects.BehaviorSubject;

public class GuideRotaryLaserManualPickFragment extends BaseFragment {
    ...
    @BindView(R2.id.vrv_laser_calibration_pick_ruler)
    ...
    public static GuideRotaryLaserManualPickFragment newInstance() {
        return new GuideRotaryLaserManualPickFragment();
    }
    ...
    void onClickSave() {
        ...
        final float initialZ = -ServiceContainer.getInstance().getService(IMachine.class).getMachineStatusSubjectHolder().getValue().originOffset.getZ();
