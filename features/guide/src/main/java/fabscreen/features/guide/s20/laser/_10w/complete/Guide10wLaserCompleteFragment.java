package fabscreen.features.guide.s20.laser._10w.complete;
...
public class Guide10wLaserCompleteFragment extends BaseFragment {
    ...
    void onClickNext() {
        ...
        ServiceContainer.getInstance().getService(IPreferences.class).getHelper().setMachineSetup10WLaser(true);
