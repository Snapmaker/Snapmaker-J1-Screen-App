...
public class GuideLaserSetOriginFragment extends BaseFragment {
    ...
    public static GuideLaserSetOriginFragment newInstance() {
        return new GuideLaserSetOriginFragment();
    }
    ...
    void onClickNext() {
        ...
        turnOffLaser()
                ...
                .subscribe(response -> {
                    mMovingEventSubject.onNext(false);
                    if (getActivity() != null) {
                        ((GuideLaserActivity) getActivity()).startAutoFocusStep1Fragment();
                    }
                }, e -> {
                    LogHelper.log(e);
                    mMovingEventSubject.onNext(false);
