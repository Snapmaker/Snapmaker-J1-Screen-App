...
public class BrowseInfoJ1Fragment extends BaseFragment {

    @BindView(R2.id.tv_print_file_info)
    TextView mTvInfo;

    @BindView(R2.id.sp_print_file_mode)
    Spinner mSpMode;
    ...
    protected int getLayoutResID() {
        return R.layout.fragment_s30_browse_print_file_info_j1;
    }
    ...
    @OnClick(R2.id.btn_browse_start_print)
    void onClickStart() {
